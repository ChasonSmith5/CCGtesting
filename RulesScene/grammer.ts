...
function checkGrammerRules(turn_based: boolean, Play_to_num: boolean, play_num_turns: boolean, action_based: boolean, energy: boolean, multi_energy: boolean, simo_turn: boolean, mult_loc: boolean, abillities: boolean, power: boolean){
  if(turn_based == true)
