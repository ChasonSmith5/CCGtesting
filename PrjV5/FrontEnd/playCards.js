...
function handleRightClick(id_passed, card, parent) {
...
function playCard(leaving, going, ID, card, parent, goingID, leavingNRG, leavingACT) {
    var canPaly = 0;
...
function unplayCard(leaving, going, ID, card, parent, goingID, goingNRG, goingACT) {
    for (let i = 1; i <= leaving.length; i++) {
        if (leaving[i - 1].id == ID) {
