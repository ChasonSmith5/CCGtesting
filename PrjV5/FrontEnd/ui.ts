...
class UpdateUI{
    contentChecker: any;
    next_turn_updates(multi: boolean | null, nrg: boolean | null, turn: boolean | null, act: boolean | null){
        if(nrg == true){
            if(multi == false){
                if(turn == true){
    ...
    update_energy_values(multi: boolean | null){
        for (var i = 0; i < settingsHandler.numTypes; i++) {
            if(multi == true){
                this.contentChecker = document.getElementById("e" + (i + 1));
                if(this.contentChecker)
    ...
    play_card(parent: any, card: any, newParent: any){
    ...
    show_visibillity(ID: string){
        var tmp = document.getElementById(ID);
        if(tmp)
            tmp.style.display = "block";
    }

    hide_visibillity(ID: string){
        var tmp = document.getElementById(ID);
        if(tmp)
            tmp.style.display = "none";
    }

    clear_children(parentID: any){
    ...
    build_card(where_to: any, where_from: any){
        ...
        switch (where_from[0].Etype) {
            case '1':
                childImage.src = 'rst.png';
                break;
            case '2':
                childImage.src = 'ost.png';
                break;
            case '3':
                childImage.src = 'yst.png';
                break;
            case '4':
                childImage.src = 'gst.png';
                break;
            case '5':
                childImage.src = 'bst.png';
                break;
            case '6':
                childImage.src = 'pst.png';
                break;
            default:
                childImage.src = 'rst.png';
                break;
